...
(function() {
    try {
        const fitModule = require('fit-file-parser');
        
        if (typeof fitModule === 'function') {
            window.FitParser = fitModule;
        } else if (fitModule.default && typeof fitModule.default === 'function') {
            window.FitParser = fitModule.default;
        } else if (fitModule.FitParser && typeof fitModule.FitParser === 'function') {
            window.FitParser = fitModule.FitParser;
        } else {
            window.FitParser = fitModule;
        }
        
        console.log('FitParser loaded:', typeof window.FitParser);
    } catch (error) {
        console.error('Error loading FitParser:', error);
    }
})();
